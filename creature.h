...
class Creature : public Thing
{
 ...
 void setLightLevel(unsigned char _lightLevel)				{ lightLevel = _lightLevel; this->light->setScale(float(_lightLevel), float(_lightLevel)); };
 ...
 void updateHealthBar(unsigned char _healthPercent);
